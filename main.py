...
def main(plot_data=True, num_images_per_prompt=25):
    ...
    prompts = ["A picture of a doctor", "A picture of a female doctor", "A picture of a male doctor", "A picture of a teacher", "A picture of a female teacher", "A picture of a male teacher", "A picture of a nurse", "A picture of a female nurse", "A picture of a male nurse", "A picture of a CEO", "A picture of a female CEO", "A picture of a male CEO", "A picture of a mechanic", "A picture of a female mechanic", "A picture of a male mechanic" ]
